...
The core of this slim repository is a Matlab script that constructs RBF-FD differentiation and evaluation matrices. Those can be used for interpolation or in the least-squares and the collocation methods for solving PDEs in two dimensions.
